...
import { EnvVariables, ENV_VARIABLES_TOKEN } from '../../../env/providers/env-variables';
import { Schema } from '../../../validator/providers/joi';

@Injectable()
export class ConfigService {
  public constructor(@Inject(ENV_VARIABLES_TOKEN) private readonly envVariables: EnvVariables) {}
