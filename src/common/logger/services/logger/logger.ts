...
import { ClsContextService } from '../../../cls/services/cls-context/cls-context';
import { Pino, PINO_TOKEN } from '../../providers/pino';
import { LogContext } from './interfaces/log-context';

@Injectable()
export class LoggerService implements NestLoggerService {
  public constructor(
    @Inject(PINO_TOKEN) private readonly pino: Pino,
